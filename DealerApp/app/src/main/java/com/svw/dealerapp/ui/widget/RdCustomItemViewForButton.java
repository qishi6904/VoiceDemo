...
public class RdCustomItemViewForButton extends RdCustomItemViewBase<Boolean, Boolean>{
    ...
    public RdCustomItemViewForButton(Context context) {
        super(context);
        mContext = context;
    }

    public RdCustomItemViewForButton(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
    }
    ...
    protected int getLayoutId() {
        return R.layout.rd_custom_item_button;
    }
