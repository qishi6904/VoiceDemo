...
public class RdDealAdapter extends RelativeDragRecyclerViewAdapter<DealCustomerEntity.DealCustomerInfoEntity> {

    private List<DealCustomerEntity.DealCustomerInfoEntity> showMonthEntities;
    private String currentUserId;

    public RdDealAdapter(Context context, List dataList,
                         List<DealCustomerEntity.DealCustomerInfoEntity> showMonthEntities) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = View.inflate(context, R.layout.rd_item_resource_deal, null);
        ...
        holder.rivItemView.setAction(context.getResources().getString(R.string.resource_deal_cus_deal));
        holder.rivItemView.setDateTitle(context.getResources().getString(R.string.resource_deal_cus_delivery_time));
        ...
        params.weight = 1;
        holder.rivItemView.setCustomerNameLayoutParams(params);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        final DealCustomerEntity.DealCustomerInfoEntity entity = dataList.get(position);
        ...
        viewHolder.rivItemView.setDate(DateUtils.dateFormat("MM.dd", "yyyy-MM-dd'T'HH:mm:ss.SSSZ", entity.getDeliveryDate()));
