 ...
 */
@Deprecated
public class SleepCustomerAdapter extends LinearDragRecyclerViewAdapter<SleepCustomerEntity.SleepCustomerInfoEntity> {
    ...
    public SleepCustomerAdapter(Context context, List<SleepCustomerEntity.SleepCustomerInfoEntity> dataList) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = View.inflate(context, R.layout.item_resource_sleep_customer, null);
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        ...
        SleepCustomerEntity.SleepCustomerInfoEntity infoEntity = dataList.get(position);

        viewHolder.tvCustomerName.setText(infoEntity.getCustName());
        viewHolder.tvSleepReason.setText(context.getResources().getString(R.string.resource_deal_cus_sleep_reason) + infoEntity.getDormancyDesc());
        viewHolder.tvSource.setText(infoEntity.getSrcTypeName());
        viewHolder.tvAction.setText(context.getResources().getString(R.string.resource_deal_cus_sleep_time) + DateUtils.dateFormat("yyyy-MM-dd", "yyyy-MM-dd'T'HH:mm:ss.SSSZ", infoEntity.getDormancyDate()));
        ...
        if("11540".equals(infoEntity.getOppStatusId())){
    ...
    private void setListener(final Holder holder, final SleepCustomerEntity.SleepCustomerInfoEntity infoEntity, final int position){
    ...
    private class Holder extends DragLinearRecyclerViewHolder {
        ...
        private TextView tvSleepReason;
        ...
        private void assignViews(View view) {
            ...
            tvSleepReason = (TextView) view.findViewById(R.id.tv_car_type);
    ...
    public interface OnIconClickListener{
        ...
        void onPhoneClick(View view, SleepCustomerEntity.SleepCustomerInfoEntity entity);

        void onActiveClick(View view, SleepCustomerEntity.SleepCustomerInfoEntity entity, int position);

        void onFollowUpClick(View view, SleepCustomerEntity.SleepCustomerInfoEntity entity, int position);

        void onTransferClick(View view, SleepCustomerEntity.SleepCustomerInfoEntity entity, int position);
