...
public class ApproveCompleteEntity {

    private List<ApproveCompleteInfoEntity> approvals;

    public List<ApproveCompleteInfoEntity> getApprovals() {
        return approvals;
    }

    public void setApprovals(List<ApproveCompleteInfoEntity> approvals) {
        this.approvals = approvals;
    }

    public static class ApproveCompleteInfoEntity {
        /**
         * approvalDesc :
         * strUpdateTime :
