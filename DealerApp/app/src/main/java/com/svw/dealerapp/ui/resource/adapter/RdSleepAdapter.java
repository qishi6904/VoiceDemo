...
public class RdSleepAdapter extends RelativeDragRecyclerViewAdapter<SleepCustomerEntity.SleepCustomerInfoEntity> {

    private List<SleepCustomerEntity.SleepCustomerInfoEntity> showMonthEntities;
    private String currentUserId;
    private OnBtnClickListener onBtnClickListener;

    public RdSleepAdapter(Context context, List dataList,
                          List<SleepCustomerEntity.SleepCustomerInfoEntity> showMonthEntities) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = View.inflate(context, R.layout.rd_item_resource_sleep, null);
        ...
        holder.rivItemView.setAction(context.getResources().getString(R.string.resource_deal_cus_sleep_action));
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        final SleepCustomerEntity.SleepCustomerInfoEntity entity = dataList.get(position);
    ...
    public interface OnBtnClickListener {
        void onBtnOneClick(View v, SleepCustomerEntity.SleepCustomerInfoEntity entity, int position);
    }
