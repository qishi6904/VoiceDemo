...
@Deprecated
public class CustomItemViewForEditTextWithMic extends CustomItemViewBase<String, String> {

    private EditTextWithMicLayout mMicEditText;

    public CustomItemViewForEditTextWithMic(Context context) {
        super(context);
    }

    public CustomItemViewForEditTextWithMic(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    @Override
    protected int getLayoutId() {
        return R.layout.custom_item_edittext_with_mic;
    }
