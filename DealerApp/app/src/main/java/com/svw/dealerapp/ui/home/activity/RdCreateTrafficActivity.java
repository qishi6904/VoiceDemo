...
/**
 * Created by lijinkui on 2018/1/24.
 */

public class RdCreateTrafficActivity extends BaseActivity implements CreateTrafficContract.View {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.rd_activity_create_traffic);
        assignViews();
            ...
            mRemarkView.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
                ...
                public void onGlobalLayout() {
                    if (mRemarkView.hasFocus()) {
                        ...
                        if (rect.bottom < ScreenUtils.getScreenHeight(RdCreateTrafficActivity.this)) {
                            int paddingBottom = ScreenUtils.getScreenHeight(RdCreateTrafficActivity.this) - (rect.bottom - rect.top) -
                                    getResources().getDimensionPixelOffset(R.dimen.activity_title_bar_height) - ScreenUtils.getStatusBarHeight(RdCreateTrafficActivity.this);
