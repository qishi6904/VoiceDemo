...
import com.svw.dealerapp.ui.newcustomer.fragment.RdNewCustomerBasicInfoFragment;
...
public class RdNewCustomerUnitedActivity extends BaseActivity implements NewCustomerContract.View {
    private static final String TAG = "RdNewCustomerUnitedActivity";
    private RdNewCustomerBasicInfoFragment mBasicInfoFragment;
    private RdCarTypeFragment mCarTypeFragment;
    private RdNewCustomerAddFollowupRecordFragment mAddFollowupFragment;
//    private NewCustomerUnitedNextFollowupPlanFragment mNextFollowupPlanUnitedFragment;
    private RdNewCustomerFollowUpPlanFragment2 mNextFollowupPlanFragment;
...
//    private NewCustomerOtherInfoFragment mOtherInfoFragment;
    ...
    public void onBackPressed() {
        ...
        dialog.setOnBtnClickListener(new CustomDialog.OnBtnClickListener() {
            ...
            public void onCancelBtnClick() {
                dialog.dismiss();
                finish();
                TalkingDataUtils.onEvent(RdNewCustomerUnitedActivity.this, "建卡第一页-取消提示-丢弃");
            }

            @Override
            public void onConfirmBtnClick() {
                dialog.dismiss();
                TalkingDataUtils.onEvent(RdNewCustomerUnitedActivity.this, "建卡第一页-取消提示-取消");
            }
        });
        dialog.show();
    }
    ...
    protected int getLayoutId() {
        return R.layout.rd_activity_new_customer_united;
    }
    ...
    private void initFragments() {
        mBasicInfoFragment = RdNewCustomerBasicInfoFragment.newInstance(mEntity);
        mCarTypeFragment = RdCarTypeFragment.newInstance(mEntity);
//        mBasicInfoFragment.setCarTypeFragment(mCarTypeFragment);
        HashMap<String, String> map = new HashMap<>();
        map.put("seriesId", mEntity.getSeriesId());
        mAddFollowupFragment = RdNewCustomerAddFollowupRecordFragment.newInstance(map);
//        mNextFollowupPlanUnitedFragment = NewCustomerUnitedNextFollowupPlanFragment.newInstance(null);
        mNextFollowupPlanFragment = RdNewCustomerFollowUpPlanFragment2.newInstance(null);
...
//        mFollowupPlanViewGroup.addFragment(mNextFollowupPlanUnitedFragment);
        mFollowupPlanViewGroup.addFragment(mNextFollowupPlanFragment);
    ...
    private void initViews() {
        ...
        mNextBt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                TalkingDataUtils.onEvent(RdNewCustomerUnitedActivity.this, "建卡第一页-下一步");
