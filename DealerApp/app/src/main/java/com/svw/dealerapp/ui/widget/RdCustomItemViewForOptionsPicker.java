...
public class RdCustomItemViewForOptionsPicker extends RdCustomItemViewBase<String, String> {
    ...
    public RdCustomItemViewForOptionsPicker(Context context) {
        super(context);
    }

    public RdCustomItemViewForOptionsPicker(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }
