...
import com.svw.dealerapp.ui.resource.adapter.FailedCustomerAdapter;
import com.svw.dealerapp.ui.resource.adapter.RdFailAdapter;
...
import com.svw.dealerapp.ui.resource.model.FailedCustomerModel;
...
public class FailedCustomerFragment extends BaseListFragment<FailedCustomerEntity, FailedCustomerEntity.FailedCustomerInfoEntity>
        implements FailedCustomerContract.View, CheckBeforeActivateYCContract.View {

    public final static String FRESH_FILTER_STRING = "com.svw.dealerapp.failed_customer.fresh";
    private static final int transferYellowCardResult = 1001;

    private CustomDialog activeDialog;
    private RdFailAdapter adapter;
    ...
    private FailedCustomerEntity.FailedCustomerInfoEntity activeEntity;
    private CustomDialog checkBeforeActivateDialog;

    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        presenter = new FailedCustomerPresenter(this, new FailedCustomerModel());
    ...
    public BaseRecyclerViewAdapter getAdapter() {
        adapter = new RdFailAdapter(getActivity(), presenter.getDataList(), presenter.getShowMonthEntities());

        setShowHorizontalTag(true);

        adapter.setOnBtnClickListener(new RdFailAdapter.OnBtnClickListener() {
            @Override
            public void onBtnOneClick(View v, FailedCustomerEntity.FailedCustomerInfoEntity entity, int position) {
                activeEntity = entity;
                if(null == checkBeforeActivateYCPresenter) {
                    checkBeforeActivateYCPresenter = new CheckBeforeActivateYCPresenter(FailedCustomerFragment.this, new CheckBeforeActivateYCModel());
                }
     ...
     * 显示激活的对话框
     */
    private void showActiveDialog(final FailedCustomerEntity.FailedCustomerInfoEntity entity, final int position) {
        if (null == activeDialog) {
            ...
            activeDialogAdapter.setContent(getResources().getString(R.string.yellow_active_fail_tip));
        }
        activeDialog.setOnBtnClickListener(new CustomDialog.OnBtnClickListener() {
            ...
            public void onConfirmBtnClick() {
                activeDialog.dismiss();
                FailedCustomerPresenter fragmentPresenter = (FailedCustomerPresenter) presenter;
                Map<String, Object> options = new HashMap<>();
                options.put("oppId", entity.getOppId());
     ...
     * @param position
     */
    private void showVipDialog(final FailedCustomerEntity.FailedCustomerInfoEntity entity, final int position) {
        ...
        transferVipDialog.setOnBtnClickListener(new CustomDialog.OnBtnClickListener() {
            ...
            @Override
            public void onConfirmBtnClick() {
                if (presenter instanceof FailedCustomerPresenter) {
                    FailedCustomerPresenter fragmentPresenter = (FailedCustomerPresenter) presenter;
                    if ("0".equals(entity.getIsKeyuser())) {
    ...
    public void setTabTipNumber(String number) {
        ...
        (mainActivity.getResourceFragment()).setTabTipNumber(3, number);
    }
    ...
    public void onShow() {
        super.onShow();
        TalkingDataUtils.onPageStart(getActivity(), "资源-战败客户");
        JLog.i("talkingDataFlag-show", "资源-战败客户");
    }

    @Override
    public void onHide() {
        super.onHide();
        TalkingDataUtils.onPageEnd(getActivity(), "资源-战败客户");
        JLog.i("talkingDataFlag-hide", "资源-战败客户");
    }
