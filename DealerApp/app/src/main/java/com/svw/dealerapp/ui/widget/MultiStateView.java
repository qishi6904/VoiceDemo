 ...
 * Every MultiStateView <b><i>MUST</i></b> contain a content mView. The content mView
 * is obtained from whatever is inside of the tags of the mView via its XML declaration
 */
public class MultiStateView extends FrameLayout {
    ...
    protected void onAttachedToWindow() {
        ...
        if (mContentView == null) throw new IllegalArgumentException("Content mView is not defined");
        setView();
    }

    /* All of the addView methods have been overridden so that it can obtain the content mView via XML
    ...
    /**
     * Returns the {@link View} associated with the {@link "com.kennyc.mView.MultiStateView.ViewState"}
     *
     * @param state The {@link "com.kennyc.mView.MultiStateView.ViewState"} with to return the mView for
     * @return The {@link View} associated with the {@link "com.kennyc.mView.MultiStateView.ViewState"}, null if no mView is present
     */
    @Nullable
    ...
    /**
     * Returns the current {@link "com.kennyc.mView.MultiStateView.ViewState"}
     *
     * @return
     */
    @ViewState
    ...
    /**
     * Sets the current {@link "com.kennyc.mView.MultiStateView.ViewState"}
     *
     * @param state The {@link "com.kennyc.mView.MultiStateView.ViewState"} to set {@link MultiStateView} to
     */
    ...
    /**
     * Shows the {@link View} based on the {@link "com.kennyc.mView.MultiStateView.ViewState"}
     */
        ...
        switch (mViewState) {
            ...
            default:
                if (mContentView == null) {
                    // Should never happen, the mView should throw an exception if no content mView is present upon creation
    ...
    /**
     * Sets the mView for the given mView state
     *
     * @param view          The {@link View} to use
     * @param state         The {@link "com.kennyc.mView.MultiStateView.ViewState"}to set
     * @param switchToState If the {@link "com.kennyc.mView.MultiStateView.ViewState"} should be switched to
     */
    ...
    /**
     * Sets the {@link View} for the given {@link "com.kennyc.mView.MultiStateView.ViewState"}
     *
     * @param view  The {@link View} to use
     * @param state The {@link "com.kennyc.mView.MultiStateView.ViewState"} to set
     */
