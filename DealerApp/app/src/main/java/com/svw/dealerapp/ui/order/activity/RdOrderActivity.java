...
import com.svw.dealerapp.ui.newcustomer.fragment.RdCarTypeFragment;
...
import com.svw.dealerapp.ui.order.fragment.RdOrderBuyerInfoFragment;
import com.svw.dealerapp.ui.order.fragment.RdOrderInfoFragment;
import com.svw.dealerapp.ui.order.fragment.RdOrderOppInfoFragment;
import com.svw.dealerapp.ui.order.fragment.RdOrderRecommendedInfoFragment;
import com.svw.dealerapp.ui.order.fragment.RdOrderReplacementInfoFragment;
...
public class RdOrderActivity extends BaseActivity implements OrderContract.View {

    private static final String TAG = "OrderActivity";
    private CustomSectionViewGroup mReplacementInfoVg, mRecommendedInfoVg, mBuyerInfoVg, mOppInfoVg, mOrderInfoVg;
    private RdOrderOppInfoFragment mOppInfoFragment;//会员信息
    private RdOrderBuyerInfoFragment mBuyerFragment;//车主信息
    private RdOrderInfoFragment mOrderInfoFragment;//订单信息(不包括意向车系)
    private RdCarTypeFragment mCarTypeFragment;
    private RdOrderReplacementInfoFragment mReplacementInfoFragment;//置换信息
    private RdOrderRecommendedInfoFragment mRecommendedInfoFragment;//朋友推荐信息
//    private View mFirstGapView;
    ...
    //15540:首次创建，0：有效，1：无效，1.1：无效要创建，2：OTD，3：OTD取消中，4：开票中，5：已开票，6：已交车
    private String mOrderStatus = "15540";
    ...
    protected int getLayoutId() {
        return R.layout.rd_activity_new_order;
    }
    ...
    public void onBackPressed() {
        ...
        if (!"15540".equals(mOrderStatus) && !"1.1".equals(mOrderStatus)) {
            super.onBackPressed();
            return;
        }
        ...
        dialog.setOnBtnClickListener(new CustomDialog.OnBtnClickListener() {
            ...
            public void onCancelBtnClick() {
                dialog.dismiss();
                finish();
                TalkingDataUtils.onEvent(RdOrderActivity.this, "订单创建页-返回提示-丢弃");
            }

            @Override
            public void onConfirmBtnClick() {
                dialog.dismiss();
                TalkingDataUtils.onEvent(RdOrderActivity.this, "订单创建页-返回提示-取消");
            }
        });
        dialog.show();
    }
...
//        mFirstGapView.setVisibility(View.VISIBLE);
    ...
    private void initFragments() {
        ...
        mOppInfoFragment = RdOrderOppInfoFragment.getInstance(mOpportunityDetailEntity);
        ...
        mBuyerFragment = RdOrderBuyerInfoFragment.newInstance(entity);
        ...
        mOrderInfoFragment = RdOrderInfoFragment.newInstance(entity);
        mCarTypeFragment = RdCarTypeFragment.newInstance(entity);
        ...
        mReplacementInfoFragment = RdOrderReplacementInfoFragment.newInstance(entity);
        ...
        mRecommendedInfoFragment = RdOrderRecommendedInfoFragment.newInstance(entity);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.order_submit_bt:
                ...
                if (("15540".equals(mOrderStatus) || "1.1".equals(mOrderStatus)) && checkFragmentCorrectness()) {
    ...
    private void promptToCancel() {
        ...
        dialog.setOnBtnClickListener(new CustomDialog.OnBtnClickListener() {
            ...
            public void onCancelBtnClick() {
                ...
                TalkingDataUtils.onEvent(RdOrderActivity.this, "订单查看页-取消订单-是");
            }

            @Override
            public void onConfirmBtnClick() {
                dialog.dismiss();
                TalkingDataUtils.onEvent(RdOrderActivity.this, "订单查看页-取消订单-否");
            }
        });
        dialog.show();
    }
