...
public class TaskECommerceEntity {

    private PageBean page;
    private List<TaskECommerceInfoEntity> data;
    ...
    public List<TaskECommerceInfoEntity> getData() {
        return data;
    }

    public void setData(List<TaskECommerceInfoEntity> data) {
        this.data = data;
    }

    public static class TaskECommerceInfoEntity{

        /**
         * currentMileage : 4177
         * oppStatusName : 跟进
         * appmTypeId : 17020
         * custMobile : 12806953835
         * custWechat : uul8sfyd0fygowm
         * infoId :
         * srcTypeName : 线索
         * businessId : 0121021e-7b75-4552-bc1e-9b882e457c3b
         * custDesc : Customer Description 描述
         * cityId : 041001
         * isWechat : 1
         ...
         * insideColorId : 3W3W
         * taskTypeId : 12
         * leadsId : d5764882-da49-48b3-a1fb-8fc42da5995f
         * demandId :
         * outsideColorNameCn : 幻影黑
         * custAge : 10030
         * taskScheduleTime : 2017-07-01 12:00:00.0
         * taskProcessTime :
         * propertyId : 13510
         * orgName : 安亭经销商
         * appmStatusName :
         ...
         * taskDesc : 11
         * outsideColorId : 3W3W
         * custEmail : 36iu0guds4@126.com
         * srcTypeId : 11030
         * provinceName :
         * currentModel : 大众 高尔夫GTI
         * purchaseName : 公司
         * paymentModeName :
         * infoName :
         * carModelId : 3E92FZ
         ...
         * updateTime :
         * custName : DB 朱
         * custTelephone : 05424139268
         * createTime :
         * propertyName : 首次
         * delayDays : ""
         * scheduleDesc :
         * insideColorNameCn : 幻影黑
         * channelName : 总部分配
         * createUser :
         * oppId : 0121021e-7b75-4552-bc1e-9b882e457c3b
         * taskId : 5026af35-73ba-45bf-9a54-e0dbb3bd9a3c
         */
