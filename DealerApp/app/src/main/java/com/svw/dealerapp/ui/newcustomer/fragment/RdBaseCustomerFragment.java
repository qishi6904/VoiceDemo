 ...
 * Created by xupan on 23/01/2017.
 */

public abstract class RdBaseCustomerFragment<T> extends BaseFragment {

    private static final String TAG = "BaseCustomerFragment";
    protected Serializable mEntity;
    protected RdCustomItemViewBase[] mAllBaseView;
    ...
    protected void setListeners() {
        ...
        for (RdCustomItemViewBase view : mAllBaseView) {
