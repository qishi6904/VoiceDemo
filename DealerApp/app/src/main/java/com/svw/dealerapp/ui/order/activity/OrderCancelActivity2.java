 ...
 */
@Deprecated
public class OrderCancelActivity2 extends BaseActivity implements CancelOrderFollowupContract.View {
    ...
    protected int getLayoutId() {
        return R.layout.activity_order_cancel2;
    }
    ...
    public void cancelOrderSuccess(int dealListPosition, String orderStatus) {
        ...
        if (OrderCancelActivity2.FOLLOW_RESULT_CONTINUE.equals(followResultCode)) {
            Intent continueIntent = new Intent(YellowCardFragment.FRESH_FILTER_STRING);
            sendBroadcast(continueIntent);
        } else if (OrderCancelActivity2.FOLLOW_RESULT_FAILED.equals(followResultCode)) {
            Intent failedIntent = new Intent(FailedCustomerFragment.FRESH_FILTER_STRING);
            sendBroadcast(failedIntent);
        } else if (OrderCancelActivity2.FOLLOW_RESULT_SLEEP.equals(followResultCode)) {
