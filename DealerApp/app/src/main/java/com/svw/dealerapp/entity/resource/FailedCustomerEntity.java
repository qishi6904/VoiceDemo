...
public class FailedCustomerEntity {

    private PageBean page;

    private List<FailedCustomerInfoEntity> data;

    public List<FailedCustomerInfoEntity> getData() {
        return data;
    }
    ...
    public void setData(List<FailedCustomerInfoEntity> data) {
        this.data = data;
    }

    public class FailedCustomerInfoEntity {
        /**
         * appmStatusId : 17520
         * appmStatusName : 已完成
         * appmTypeId : 17010
