 ...
 * Created by xupan on 18/01/2017.
 */

public abstract class RdCustomItemViewBase<T, S> extends LinearLayout {

    protected Context mContext;
    protected LinearLayout mRootLayout;
    protected RelativeLayout mContentLayout;//相对布局，且id固定
    protected View mRootView;
    protected View mMandatoryView;//必填标志
    ...
    public RdCustomItemViewBase(Context context) {
        super(context);
        mContext = context;
        initViews();
        setListeners();
    ...
    public RdCustomItemViewBase(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        initViews();
        setListeners();
    ...
    protected void initViews() {
        ...
        mMandatoryView = view.findViewById(R.id.custom_item_mandatory_view);
    ...
    public void setMandatory(boolean mandatory) {
        ...
        mMandatoryView.setVisibility(mandatory ? VISIBLE : INVISIBLE);
    }
...
//        mMandatoryView.setTextSize(textSize);
//    }
    ...
    public void setLeftRightMargin(int left, int right) {
        LinearLayout.LayoutParams params1 = (LinearLayout.LayoutParams) mMandatoryView.getLayoutParams();
        params1.leftMargin = left;
        mMandatoryView.setLayoutParams(params1);
