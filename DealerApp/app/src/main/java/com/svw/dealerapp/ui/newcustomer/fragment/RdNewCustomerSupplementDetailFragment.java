...
/**
 * 建卡-补充潜客信息-付款方式，内外饰颜色等
 * Created by xupan on 26/01/2018.
 */

public class RdNewCustomerSupplementDetailFragment extends RdBaseCustomerFragment implements View.OnClickListener {

    private static final String TAG = "NewCustomerRequirementsDetailFragment";
    private TableRow mOuterColorTr, mInnerColorTr;
    private TextView mOuterColorTv, mInnerColorTv;
    private RangeSeekBar mBudgetSeekbar;
    private RangeSeekBar mBudgetGraySeekbar;
    private RecyclerView mRequirementsRv;
    private OptionsPickerView mInnerColorPicker, mOuterColorPicker;
    private RelativeLayout rlRootView;
    private InterceptTouchCoverView itvCoverView;

    private List<String> mInnerColorCodeList, mOuterColorCodeList, mRequirementCodeList;
    private List<String> mInnerColorValueList, mOuterColorValueList, mRequirementValueList;
    ...
    private RdCustomItemViewForOptionalPackage mPackageView;

    public static RdNewCustomerSupplementDetailFragment newInstance(Serializable entity) {
        RdNewCustomerSupplementDetailFragment fragment = new RdNewCustomerSupplementDetailFragment();
    ...
    protected int getLayoutId() {
        return R.layout.rd_fragment_new_customer_supplement_detail;
    }
...
//                JLog.d(TAG, "min: " + min + "| max: " + max);
        ...
        mPackageView = (RdCustomItemViewForOptionalPackage) view.findViewById(R.id.new_customer_step_2_intention_package);
