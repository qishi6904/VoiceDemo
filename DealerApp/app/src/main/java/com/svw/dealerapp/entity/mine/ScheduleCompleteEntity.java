...
public class ScheduleCompleteEntity {
    ...
    private List<ScheduleCompleteInfoEntity> appointmentList;

    private PageBean page;

    public List<ScheduleCompleteInfoEntity> getAppointmentList() {
        return appointmentList;
    }

    public void setAppointmentList(List<ScheduleCompleteInfoEntity> appointmentList) {
    ...
    public static class ScheduleCompleteInfoEntity {
        /**
         * appmTypeId : 17020
