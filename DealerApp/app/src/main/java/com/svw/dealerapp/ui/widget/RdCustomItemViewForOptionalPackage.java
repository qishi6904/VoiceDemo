...
public class RdCustomItemViewForOptionalPackage extends RdCustomItemViewBase<List<String>, List<String>>{

    private static final String TAG = "CustomItemViewForEditText";
    private Context mContext;
    private RecyclerView mRecyclerView;

    public RdCustomItemViewForOptionalPackage(Context context) {
        super(context);
        mContext = context;
    }

    public RdCustomItemViewForOptionalPackage(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
    }
    ...
    protected int getLayoutId() {
        return R.layout.rd_custom_item_optional_package;
    }
    ...
    private class ContentsAdapter extends RecyclerView.Adapter<ContentsAdapter.RecyclerViewHolder> {
        ...
        @Override
        public ContentsAdapter.RecyclerViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_custom_item_optional_package, parent, false);
            return new ContentsAdapter.RecyclerViewHolder(view);
        }

        @Override
        public void onBindViewHolder(ContentsAdapter.RecyclerViewHolder holder, int position) {
