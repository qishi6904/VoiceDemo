...
public class DealCustomerFilterActivity extends BaseFilterActivity implements DealCusFilterContract.View {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        tvTitle.setText(getResources().getString(R.string.resource_deal_filter_title));
    ...
    public void assignViews() {
        setContentView(R.layout.activity_deal_cus_filter);
        ...
        switch (v.getId()){
            case R.id.tv_confirm:   //确定
                ...
                DealCusFilterIntentEntity filterIntentEntity = new DealCusFilterIntentEntity(sourceSelectList,
                        ...
                        deliveryPeriodDatePicker.getEndTimeDate(), deliveryPeriodDatePicker.getStartTime(), deliveryPeriodDatePicker.isSelectAllTime(),
