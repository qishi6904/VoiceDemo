...
@Deprecated
public class CustomItemViewForRadioButton extends CustomItemViewBase<String, String> {
    ...
    public CustomItemViewForRadioButton(Context context) {
        super(context);
    }

    public CustomItemViewForRadioButton(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    @Override
    protected int getLayoutId() {
        return R.layout.custom_item_two_item_radiobutton;
    }
